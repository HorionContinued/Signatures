...
<main>
	<div class="mx-5">
		<input bind:value={$searchTermStore} placeholder="name, description or signature" class="w-full bg-white bg-opacity-5 rounded-xl p-2 px-3"/>
	</div>
	<div class="m-5 h-[calc(100vh-200px)]">
